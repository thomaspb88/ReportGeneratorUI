...
namespace ReportGenerator.Presentation
{
...

    {
        ...
        public GalaSoft.MvvmLight.CommandWpf.RelayCommand ShowPopUpCommand { get; private set; }
        public GalaSoft.MvvmLight.CommandWpf.RelayCommand AddTestsCommand { get; private set; }
        public GalaSoft.MvvmLight.CommandWpf.RelayCommand RemoveTestCommand { get; private set; }
        public GalaSoft.MvvmLight.CommandWpf.RelayCommand CreateReportCommand { get; private set; }
        ...
        private IReportItemReader DataReader;
